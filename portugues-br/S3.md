...
- Os buckets devem ter um nome globalmente ***único (em todas as regiões e contas)***
- Os buckets são definidos no nível da região
- O S3 parece ser um serviço global, mas os buckets são criados em uma região
- Convenção de nomenclatura
  - Sem maiúsculas, sem sublinhado
  - Comprimento de 3 a 63 caracteres
  - Não pode ser um IP
